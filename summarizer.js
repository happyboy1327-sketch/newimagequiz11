...
const CORE_SIGNIFICANCE_KEYWORDS = [
  "원리", "구조", "기능", "작용", "현상", "이론", "연구", "발견", "발명", "규명", "증명", "성과", "조직", "제작",  
  "분석", "기반", "시스템", "메커니즘", "특징", "성질", "분류", "상태", "상호작용", "개척", "혁명", "유지", 
  "제도", "정책", "사회", "경제", "체계", "관계", "변화", "전개", "성장", "효과", "고안", "창제", "반대", 
  "원인", "결과", "분포", "개혁", "조약", "협정", "시장", "구조적", "통일", "통합", "정합", "집대성", 
  "양식", "사상", "문화", "작품", "기법", "전통", "유형", "형성", "창작", "유산", "완화", "중시", 
  "대표", "영향", "의의", "기여", "발전", "역사", "중심", "주요", "운동", "시행", 
  "지정", "설립", "주도", "구성", "기록", "도입", "확립", "공격", "격퇴", "정벌", "함락"
];

const ACHIEVEMENT_VERB_REGEX = /(?:저술|집필|설계|고안|집대성|제시|편찬|주창|발명|성공|창안|개혁|건축|축조|간행|통찰|창작|창시|정리|도입|확립|반영|기여|주도|설립|격퇴|정벌|연구|지휘|승리|격파|격침|건조|수호|통제|구원|평정|혁신|창설|발견)/;
...
export function stripMetainfo(text) {
  ...
  result = result
    ...
    .replace(/^(?:이며|이고|이자)\s*/, "")
    .replace(/,?\s*(?:자|호|본관|시호|아호|별호|태명|세례명|일명|아명|법명|묘호)\s*는\s*.*$/g, "")
    .replace(/^(?:이며|이고|이자)\s*/, "");
