...
export function stripMetainfo(text) {
  ...
  result = result
    ...
    .replace(/([가-힣]+)(?:으로|며|이고|이자|이며)(?:이다)?\s*\./g, "$1이다.") //어미 보정 2
...
const TMI_NOISE_REGEX = /(?:부친|모친|조부|증조부|고조부|외가|오대손녀|첫\s*부인|둘째\s*부인|가계도|손자|처남|장인|결혼|이혼|혼인|재혼|파혼|배우자|남편|아내|며느리|사위|처가|딸|아들|시댁|장남|차남|장녀|차녀|외아들|외딸|\d남|\d녀|가정교사|야학|위인전|그림위인전기|계몽사|출판사|소설가|에\s*따르면|에\s*의하면)/;
