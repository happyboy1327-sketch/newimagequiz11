...
const ACHIEVEMENT_REGEX = /(기여|설립|개발|발견|창시|주도|발표|영향|성공|구축|혁명|수상|창립|저술|저서|총괄|개혁|정립|주창|체계화|확산|보급|창안|집대성|기틀|초석|승리|평정|확장|창시자|개척자|아버지|대표|중요한|업적|연구|논문|작품|창작|발명|개진|동조|지지|해석|반대|논쟁|부활|수로도|관측|역임|소설가|작가|문학|소설|시인|화가|음악가|철학자|사상가|정치가|과학자|물리학자|수학자|교수|활동|집필|출판|발간|언론인|기자|활동을|작업|완성)/;

// TMI / 단순 출생/가족/외부 평가 관련 정제 대상
const HARD_NOISE_REGEX = /(의\s*(?:아들|딸|손자|손녀|부인|아내|남편|부친|모친|차남|장남|자녀|후손|부모)|결혼하|슬하에|일화|여담|소문|전해진다|체육관|유적|오차가\s*생긴다|차이를\s*보이고|이설이\s*있다|태어나|유학을|출생하였다|여행을|구글|두들|기념하여|제작되었다|생일을|저널|시대착오|현모양처)/;
